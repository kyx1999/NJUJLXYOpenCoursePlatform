...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:GridView ID="gvProduct" runat="server" AllowPaging="True" AutoGenerateColumns="False" DataKeyNames="ProductId" DataSourceID="ldsProduct" PageSize="5">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="商品分类编号">
                        ...
                        <EditItemTemplate>
                            <asp:DropDownList ID="ddlCategory" runat="server" DataSourceID="ldsCategory" DataTextField="Name" DataValueField="CategoryId" SelectedValue='<%# Bind("CategoryId") %>'></asp:DropDownList>
            ...
            <asp:LinqDataSource ID="ldsProduct" runat="server" ContextTypeName="MyPetShopDataContext" EnableUpdate="True" TableName="Products"></asp:LinqDataSource>
