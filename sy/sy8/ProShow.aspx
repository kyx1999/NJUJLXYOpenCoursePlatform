<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProShow.aspx.cs" Inherits="sy8_ProShow" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            分类名：<asp:DropDownList ID="ddlCategory" runat="server" AutoPostBack="True" DataTextField="Name" DataValueField="CategoryId" OnSelectedIndexChanged="DdlCategory_SelectedIndexChanged"></asp:DropDownList>
